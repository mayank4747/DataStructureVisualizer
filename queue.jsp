...
<script src='js/queue_function.js'></script>
...
<a href="#enqueueModal" id='enqueue' data-toggle="modal" onclick="enqueueModal()"> ENQUEUE</a>
  <a href="#" id='dequeue' data-toggle="modal" onclick="dequeueFunction()">DEQUEUE</a>
  <a href="#" id='clearQueue' data-toggle="modal" onclick="clearQueueFunction()">CLEAR QUEUE</a>
</div>


<div class="main">

<H1 id="heading">QUEUE - First In First Out (FIFO)</H1> 
<H3 id='tc'></H3><br><br>
...
<div class="modal fade" id="enqueueModal" tabindex="-1" role="dialog" aria-labelledby="enqueueModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="enqueueModalLabel">ENQUEUE </h5>
       <button type="button" class="close" data-dismiss="modal" aria-label="close">&times; </button>
      </div>
      <div class="modal-body">
   <small>Enter Element</small>
        <input type="number" class="form-control" id="enqueueElement" name="enqueueElement" placeholder="ENTER ELEMENT">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
   <button type="button" class="btn btn-primary" class="close" data-dismiss="modal" onclick="enqueueFunction()">INSERT</button>
      </div>
    </div>
  </div>
</div>
